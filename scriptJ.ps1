...
$javaFileName = $args[0] # Nume fisier java
#Write-Host $param1

$strategyNr = $args[1] # No of threads
#Write-Host $param2

$inputFileNr = $args[2] # No of runs
#Write-Host $param3

$threadsNr = $args[3] # No of file
#Write-Host $param4
...
for ($i = 0; $i -lt 10; $i++){
    ...
    $a = java $javaFileName $strategyNr $inputFileNr $threadsNr # rulare class java
...
# Append
Add-Content outJ.csv ",$($strategyNr),$($fileInputNr),$($media)"